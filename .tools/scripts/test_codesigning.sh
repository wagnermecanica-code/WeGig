...
if [ ! -f "packages/app/ios/WeGig.xcodeproj/project.pbxproj" ]; then
...
TEAM_ID=$(xcodebuild -project WeGig.xcodeproj -showBuildSettings -configuration $CONFIGURATION 2>/dev/null | grep "DEVELOPMENT_TEAM" | head -1 | awk '{print $3}')

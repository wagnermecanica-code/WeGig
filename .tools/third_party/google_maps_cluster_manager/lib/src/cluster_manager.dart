...
class ClusterManager<T extends ClusterItem> {
  ...
  Future<void> setItems(List<T> newItems) {
    _items = newItems;
    return updateMap();
  }
  ...
  /// No-op dispose preserved for backward compatibility.
  void dispose() {}
}

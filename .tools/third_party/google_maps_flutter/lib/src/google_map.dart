...
MapConfiguration _configurationFromMapWidget(GoogleMap map) {
  final hasCloudMapId = map.cloudMapId != null && map.cloudMapId!.isNotEmpty;
  ...
  return MapConfiguration(
    ...
    // When a cloud map ID is present, Android logs a warning if any style
    // update is sent, including an empty-string clear operation.
    style: hasCloudMapId ? null : map.style ?? '',
  );
}

...
| ----------- | ------------------------------- | -------------------------------------- |
| WeGig (Dev) | `com.wegig.dev.app`             | `com.tosembanda.wegig.dev`             |
| WeGigTests  | `com.wegig.dev.app.RennerTests` | `com.tosembanda.wegig.dev.RennerTests` |
...
- ✅ `packages/app/ios/WeGig/GoogleService-Info.plist`
...
- WeGig: com.tosembanda.wegig.dev (matches wegig-dev Firebase project)
- WeGigTests: com.tosembanda.wegig.dev.RennerTests
